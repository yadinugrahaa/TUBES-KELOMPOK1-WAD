    ...
    <div class="container pt-5 pb-5">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-4">
                ...
                <p class="text-center" id="kasir">Zepatoe Shoes</p>
            </div>
        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-9">
                <p id="bottom-text-invoice">Invoice ini sah dan diproses oleh komputer <br>
                    Silahkan hubungi <span id="span-bottom-invoice">ZepatoeShoes Help</span> apabila anda membutuhkan
                    bantuan.</p>
            </div>
        </div>
</section>
